export type DiplomaCategory = "titulo" | "especializacion" | "curso";
...
export const credentials: Diploma[] = [
  {
    ...
    year: 2012,
    category: "titulo",
    description: "Título de grado — Facultad de Odontología UBA",
  },
  {
    id: "esp-estetica",
    title: "Especialización en Odontología Estética",
    institution: "AAOC — Asociación Argentina de Odontología Cosmética",
    year: 2016,
  ...
  },
  {
    ...
    institution: "AAII — Asociación Argentina de Implantología Ítalo-Ibérica",
    year: 2020,
    category: "especializacion",
  },
  {
